When you have many developers committing many branches to a large git repo things can get messy fast, depending on the strategy you use for merging and branching.
